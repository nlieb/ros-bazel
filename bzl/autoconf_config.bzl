...
autoconf_config = rule(
    attrs = {
        ...
        "autoconf_config_gen": attr.label(
            cfg = "host",
            executable = True,
            default = Label("//bzl:autoconf_config_gen"),
        ),
    },
...
autoconf_standard_defines = [
    ...
    "//bzl/constraints:long_double_16bytes": [
        "SIZEOF_LONG_DOUBLE=16",
    ],
    "//bzl/constraints:long_double_8bytes": [
        "SIZEOF_LONG_DOUBLE=8",
    ],
}) + select({
    "//bzl/constraints:long_8bytes": [
    ...
    "//bzl/constraints:sizet_8bytes": [
        "SIZEOF_SIZE_T=8",
        "SIZEOFSSIZE_T=8",
    ],
    "//bzl/constraints:sizet_4bytes": [
        "SIZEOF_SIZE_T=4",
        "SIZEOFSSIZE_T=4",
    ],
}) + select({
